...
// no size of its own to fall back on if that container's own sizing
// ever regresses, which is exactly how this icon once ballooned to
// fill an entire row (pages-hub.css's .instance-row-main a briefly
